		        ...
		        <form name="formInsert" class="form-horizontal" role="form">
		            <div class="col-md-4">
		            	<div class="form-group" >
							  ...
							  <input style="width:10%;" type="checkbox" ng-model="Checkbox['usuaunit']">
		            	</div>
		            	<div class="form-group" >
							  ...
							  <input style="width:10%;" type="checkbox" ng-model="Checkbox['usuarazo']">
		            	</div>
		        		...
		        		<div ng-show="Devolver"><p/>
			            	...
			            	<div class="form-group" >
								  ...
								  <div class="col-sm-8">			
									<select class="form-control" name ="devonomb" id="devonomb" ng-model="Campos['devonomb']" ng-options="opt.value as opt.label for opt in optionsMotivo" ng-click="putDesc()"></select>
								  </div>
			            	</div>
			            	<div class="form-group" >
			            		  <label for="devodesc" class="col-sm-4 control-label"><label><font color="red">*</font></label>{{devodesclabel}}</label>
								  <div class="col-sm-8">			
									<textarea style="width:100%;" name ="devodesc" id="devodesc" ng-model="Campos['devodesc']" ng-trim="false"></textarea>
								  </div>							  
			            	</div>
