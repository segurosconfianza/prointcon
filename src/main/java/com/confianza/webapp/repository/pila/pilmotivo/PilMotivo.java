...
@Entity
@Table(name = "PIL_MOTIVO")
public class PilMotivo {
	@Id 
	// Habilite este codigo para generar automaticamente la llave primaria esta depende de una tabla
	@TableGenerator(name = "PIL_MOTIVO_GEN", //<= nombre de la tabla con el cual se va a identificar la llave
	                 ...
	                 pkColumnValue="PIL_MOTIVO_PK", 
	                 initialValue = 1,                //<= Valor inicial de la llave primario
	                 allocationSize = 1)              //<= Valor a buscar por medio de la llave primaria
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "PIL_MOTIVO_GEN")  
