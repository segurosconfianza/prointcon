...
public class PilLog {
	...
	@TableGenerator(name = "PIL_LOG_GEN", //<= nombre de la tabla con el cual se va a identificar la llave
	                 ...
	                 pkColumnValue="PIL_LOG_PK", 
	                 initialValue = 1,                //<= Valor inicial de la llave primario
	                 allocationSize = 1)              //<= Valor a buscar por medio de la llave primaria
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "PIL_LOG_GEN")  
